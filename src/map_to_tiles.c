...
const uint8_t const map_to_tiles_data[4][128] =
{
{
    ...
    TILE_GUN_DOWN, TILE_GUN_LEFT, TILE_GUN_RIGHT, TILE_GUN_UP, TILE_GUN_DOWN, TILE_GUN_UP2, TILE_GUN_UP2, TILE_EXPLOSION1, 
