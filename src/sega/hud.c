...
#define TILE_HUD_SEGA_NUM_PART0 0
#endif
#ifndef TILE_HUD_SEGA_SCREW
#define TILE_HUD_SEGA_SCREW
#endif

#if defined(MASTERSYSTEM)
#define hudY 175U
#elif defined(GAMEGEAR)
#define hudY (127U+fixY)
#else
...
{
    hudY, hudY + 8U, hudY, hudY + 8U, hudY, hudY + 8U, hudY, hudY + 8U,
    hudY, hudY + 8U, hudY, hudY + 8U, hudY, hudY + 8U, hudY, hudY + 8U,
};
...
const uint8_t hud_sprites_x_tile[] =
{
    ...
    hudX + 64, TILE_HUD_SEGA_SCREW + 8U, hudX + 64, TILE_HUD_SEGA_SCREW + 10, hudX + 72, TILE_HUD_SEGA_SCREW + 9, hudX + 72, TILE_HUD_SEGA_SCREW + 11,
